  ...
  <tr>
    <td align="right" valign="middle">
      <p style="font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 13px; margin: 0;">
        <a href="#sobre-mi" style="color: #ff758f; text-decoration: none; font-weight: bold;">[ Sobre Mí ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#habilidades" style="color: #8a7673; text-decoration: none; font-weight: bold;">[ Habilidades ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#experiencia" style="color: #8a7673; text-decoration: none; font-weight: bold;">[ Experiencia ]</a> &nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#contacto" style="color: #8a7673; text-decoration: none; font-weight: bold;">[ Contacto ]</a>
      </p>
    </td>
  </tr>
</table>

<hr border="1" color="#ffb3c1" style="opacity: 0.3; margin-top: 15px; margin-bottom: 30px;">
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td width="50%" valign="top" style="padding-right: 20px;">
      <h2 style="color: #ff758f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 28px; margin-top: 0; margin-bottom: 15px;">Sobre Mí</h2>
      <p style="color: #4a3e3c; font-family: 'Segoe UI', Arial, sans-serif; font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
      ...
      <p style="color: #ff758f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 14px; font-weight: bold; margin-top: 20px;">
...
<!-- SECCIÓN: HABILIDADES -->
<a id="habilidades"></a>
<h2 style="color: #ff758f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 24px; margin-bottom: 25px;">Habilidades &amp; Tecnologías</h2>
...
<!-- SECCIÓN: EXPERIENCIA -->
<a id="experiencia"></a>
<h2 style="color: #ff758f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 24px; margin-bottom: 25px;">Experiencia &amp; Proyectos</h2>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 20px; padding-bottom: 30px;">
      ...
      <p style="color: #8a7673; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 13px; margin: 0 0 10px 0; font-weight: bold;">Universidad de Informática</p>
      <p style="color: #4a3e3c; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; line-height: 1.5; margin: 0;">
  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 20px; padding-bottom: 20px;">
      ...
      <p style="color: #8a7673; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 13px; margin: 0 0 10px 0; font-weight: bold;">Proyectos de Aprendizaje</p>
      <p style="color: #4a3e3c; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; line-height: 1.5; margin: 0;">
...
<!-- SECCIÓN: CONTACTO -->
<a id="contacto"></a>
<hr border="1" color="#ffb3c1" style="opacity: 0.3; margin-bottom: 30px;">

<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center">
      <h3 style="color: #ff758f; font-family: 'MS Sans Serif', Arial, sans-serif; font-size: 20px; margin-top: 0; margin-bottom: 15px;">¡Hablemos! 💬</h3>
      <p style="color: #8a7673; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; margin-bottom: 20px;">
