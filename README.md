...
<hr border="1" color="#d4c5b9" style="opacity: 0.15; margin-top: 15px; margin-bottom: 30px;">
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td width="55%" valign="top" style="padding-right: 20px;">
      ...
      <p style="color: #e6dfd3; font-family: 'Segoe UI', sans-serif; font-size: 16px; line-height: 1.6; margin-bottom: 15px;">
      ...
      <p style="color: #e6ca9c; font-family: 'Segoe UI', sans-serif; font-size: 15px; font-weight: bold; margin-top: 20px;">
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 20px; padding-bottom: 30px;">
      ...
      <p style="color: #e6ca9c; font-family: 'Segoe UI', sans-serif; font-size: 14px; margin: 0 0 10px 0; font-weight: bold;">Universidad de Informática</p>
      <p style="color: #a39e93; font-family: 'Segoe UI', sans-serif; font-size: 14px; line-height: 1.5; margin: 0;">
  ...
  <tr>
    ...
    <td valign="top" style="padding-left: 20px; padding-bottom: 20px;">
      ...
      <p style="color: #e6ca9c; font-family: 'Segoe UI', sans-serif; font-size: 14px; margin: 0 0 10px 0; font-weight: bold;">Proyectos de Aprendizaje</p>
      <p style="color: #a39e93; font-family: 'Segoe UI', sans-serif; font-size: 14px; line-height: 1.5; margin: 0;">
...
<!-- SECCIÓN: CONTACTO -->
<a id="contacto"></a>
<hr border="1" color="#d4c5b9" style="opacity: 0.15; margin-bottom: 30px;">

<table border="0" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center">
      <h3 style="color: #f3eee3; font-family: 'Segoe UI', sans-serif; font-size: 20px; margin-top: 0; margin-bottom: 15px;">¡Hablemos! 💬</h3>
      <p style="color: #a39e93; font-family: 'Segoe UI', sans-serif; font-size: 14px; margin-bottom: 20px;">
